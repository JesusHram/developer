...
def reporte_clientes():
    ...
    def render_row(row: dict):
        ...
        return rx.table.row(
            ...
            rx.table.cell((row["RateNB"])),
            rx.table.cell((row["MillasNB"])),
            rx.table.cell((row["VaciasNB"])),
            rx.table.cell((row["rpmNB"])),
            rx.table.cell((row["SB"])),
            rx.table.cell((row["RateSB"])),
            rx.table.cell((row["MillasSB"])),
            rx.table.cell((row["VaciasSB"])),
                ...
                rx.card(
                    rx.hstack(
                        ...
                        rx.button ("Limpiar Filtros", 
                                   ...
                                   disabled=State.loading),
                        rx.link(
                            rx.button("Descargar Excel"),
                            href=State.get_excel_url,
                            is_external=True
                        ),
                        spacing="3",
                        width="100%",
                ...
                rx.table.root(
                    rx.table.header(
                        rx.table.row(
                            ...
                            rx.table.column_header_cell("RateNB"),
                            rx.table.column_header_cell("MillasNB"),
                            rx.table.column_header_cell("VaciasNB"),
                            rx.table.column_header_cell("rpmNB"),
                            rx.table.column_header_cell("SB"),
                            rx.table.column_header_cell("RateSB"),
                            rx.table.column_header_cell("MillasSB"),
                            rx.table.column_header_cell("VaciasSB"),
